...
import moonImage from "../../assets/destination/image-titan.png";
import SubNavbar from "../../component/SubNavbar";
function Titian() {
  return (
    <main className="min-h-screen bg-[url(./assets/destination/background-destination-mobile.jpg)] md:bg-[url(./assets/destination/background-destination-tablet.jpg)] lg:bg-[url(./assets/destination/background-destination-desktop.jpg)] ">
      <Navbar />
        ...
        <div className="lg:flex lg:justify-evenly lg:mt-[4rem]">
          ...
          <div className=" flex flex-col items-center lg:items-start ">
            ...
            <p className="text-[#D0D6F9] text-center text-[0.9rem] leading-[180%]  font-[Barlow] w-[20.5rem] md:w-[32.2rem] md:text-[1rem]  lg:text-left lg:w-[27.8rem] lg:leading-[180%] lg:text-[1.2rem]">
              ...
              Titian is a home away from home(just a few hundred degrees
